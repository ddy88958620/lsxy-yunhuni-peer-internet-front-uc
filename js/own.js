...
$(function(){
  ...
  for (var i = 0; i <= 11; i += 1) {
    a1.push([i, parseInt((Math.floor(Math.random() * (1 + 20 - 10))) + 10)]);
  }
  ...
  var a2 = [];
  for (var i = 0; i <= 6; i += 1) {
    a2.push([i, parseInt((Math.floor(Math.random() * (1 + 30 - 10))) + 10)]);
  }
  var a3 = [];
  for (var i = 0; i <= 6; i += 1) {
    a3.push([i, parseInt((Math.floor(Math.random() * (1 + 30 - 10))) + 10)]);
  }
...
$(function(){
  ...
  var b1 = [];
  for (var i = 0; i <= 11; i += 1) {
    b1.push([i, parseInt((Math.floor(Math.random() * (1 + 20 - 10))) + 10)]);
  }
  $("#flot-1ine").length && $.plot($("#flot-1ine"), [{
          data: b1
      }], 
  ...
  var b2 = [];
  for (var i = 0; i <= 6; i += 1) {
    b2.push([i, parseInt((Math.floor(Math.random() * (1 + 30 - 10))) + 10)]);
  }
  var b3 = [];
  for (var i = 0; i <= 6; i += 1) {
    b3.push([i, parseInt((Math.floor(Math.random() * (1 + 30 - 10))) + 10)]);
  }
  $("#flot-chart").length && $.plot($("#flot-chart"), [{
          data: b2,
          label: "Unique Visits"
